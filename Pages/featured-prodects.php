        ...
        <div class="best-saller-handler">
            <div class="container">
                <div class="row">
                        ...
                        <div class="col-md-6 ">
                                <div class="section-button" id="deskbtn">
                                <!--<a style="--clr: #7808d0" class="button" href="all.php">-->
                ...
                <div class="best-saller-prodects-list">
                    <div class="swiper Prodectslist">
                        ...
                        <?php while($q = mysqli_fetch_array($featuredsearch_result)):?>
                            <div class="swiper-slide">
                                ...
                                <div class="prodect-details">
                                    ...
                                    <div class="prodect-content">
                                        ...
                                        <span style="font-size:17px"> price: <br> <b><?php echo $q['price'];?>/-</b></span>
